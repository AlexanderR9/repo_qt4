...
{
//    settings.setValue("app_settings/icon_size", iconSize);
...
{
//    enum SimpleDataTypes {sdtString = 701, sdtIntLine, sdtDoubleLine, sdtStringCombo, sdtIntCombo, sdtDoubleCombo, sdtFilePath, sdtDirPath, sdtBool, sdtBoolCombo};
